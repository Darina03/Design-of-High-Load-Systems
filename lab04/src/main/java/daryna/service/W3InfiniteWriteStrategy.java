...
public class W3InfiniteWriteStrategy implements WriteStrategy {

    private final WriteConcern writeConcern = new WriteConcern(3, 0);
    ...
    @Override
    public String name() { return "w3_infinite"; }
}
